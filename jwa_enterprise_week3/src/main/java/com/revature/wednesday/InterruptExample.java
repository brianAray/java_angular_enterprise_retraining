...
public class InterruptExample {
    public static void main(String[] args) {
        ...
        // Here I will instnatitate a thread by passing a runnable object to its constructor
        Thread compThread = new Thread(new LongComputationTask(new BigInteger("400000000000000000"), new BigInteger("20000000000000")));
