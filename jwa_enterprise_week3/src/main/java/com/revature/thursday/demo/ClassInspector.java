...
public class ClassInspector {
    ...
    public static void listNonPublicFields(Class<?> clazz){
        ...
        for(Field field : fields){
            // I check to see what field is public and skip it if it is
    ...
    public static void listPublicMethods(Class<?> clazz){
        ...
        for(Method method: methods){
            // I don't want methods that are from the object class
    ...
    public static void listDeclaredMethods(Class<?> clazz){
        System.out.println("Listing all the declared methods of the class: " + clazz.getName());
